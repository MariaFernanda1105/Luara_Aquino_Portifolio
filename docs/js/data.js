/* ============================================================
   ...
   * Imagens em /assets são fotografias reais das obras.
   ============================================================ */
...
const OBRAS = [
  {
    ...
    imagem: "assets/obra-ponte-paraiso-real.png",
    status: "acervo",
  ...
  },
  {
    ...
    dimensoes: "60 × 90 cm",
    serie: "Com Passo, Descompasso, Ato",
    imagem: "assets/obra-efeito-formal-real.png",
    status: "disponivel",
    preco: 2400,
  ...
  },
  {
    ...
    dimensoes: "50 × 70 cm",
    serie: "Com Passo, Descompasso, Ato",
    imagem: "assets/obra-corrente-real.png",
    status: "disponivel",
    preco: 980,
  ...
  },
  {
    ...
    imagem: "assets/obra-espiral-real.png",
    status: "disponivel",
    preco: 1200,
  ...
  },
  {
    ...
    dimensoes: "70 × 100 cm",
    serie: "Estudos em papel",
    imagem: "assets/obra-abraco-real.png",
    status: "doada",
  ...
  },
  {
    ...
    imagem: "assets/salve-cerrado-equipe.png",
    status: "disponivel",
    preco: 3200,
